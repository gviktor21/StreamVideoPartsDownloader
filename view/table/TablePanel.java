 ...
 * 
 * @author Godó Viktor
 * Egy panel, ami felhasználói felületet biztosít custom táblák létrehozásához
 *
 */
public class TablePanel extends JPanel {
	...
	public TablePanel(String[] oszlopok){
		...
		tabla=new JTable(tablemodel);
		tabla.getColumnModel().getColumn(2).setCellRenderer(new DownloadProgressBarRenderer());
		scrollablak = new JScrollPane(tabla);
		add(scrollablak);	
	}
	/**
	...
	public void updateProgress(int progress) {
		...
		tablemodel.setValueAt(progress, rowCount-1, 2);
	}
}
